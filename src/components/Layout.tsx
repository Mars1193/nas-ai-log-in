        ...
        <header className="fixed top-0 left-0 right-0 z-50 glass-pane backdrop-blur-lg border-b border-slate-800">
            <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div className="hidden lg:flex items-center gap-x-6 text-sm">
                    <Link to="/" className="hover:text-[#00F0FF]">Home</Link>
                    <Link to="/showroom" className="hover:text-[#00F0FF]">Showroom</Link>
                    <Link to="/services" className="hover:text-[#00F0FF]">Services</Link>
                </div>
                <div className="flex items-center space-x-2">
                    <button className="p-2 rounded-full hover:bg-slate-800"><Globe className="w-5 h-5" /></button>
                        ...
                        <div className="hidden md:flex items-center space-x-2">
                            <Link to="/login" className="px-4 py-2 text-sm font-bold hover:bg-slate-800 rounded-lg flex items-center gap-2"><LogIn className="w-4 h-4" /> Login</Link>
                            <Link to="/signup" className="px-4 py-2 text-sm font-bold bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center gap-2"><UserPlus className="w-4 h-4" /> Sign Up</Link>
                        </div>
                    )}
                </div>
            </nav>
